...
import { Cubism2ExpressionDef } from './defs';
import { Live2DExpression } from './Live2DExpression';

export class Cubism2ExpressionManager extends ExpressionManager<Live2DModelWebGL, Cubism2ModelSettings, Live2DExpression, Cubism2ExpressionDef> {
    ...
    getExpressionFile(definition: Cubism2ExpressionDef): string {
        return definition.file;
    }

    createExpression(data: JSONObject, definition: Cubism2ExpressionDef | undefined): Live2DExpression {
        return new Live2DExpression(data);
    }

    protected getDefinitions(): Cubism2ExpressionDef[] {
