...
```html
<script src="https://cdn.jsdelivr.net/gh/RaSan147/pixi-live2d-display@v1.0.1/dist/index.min.js"></script>

<!-- if only Cubism 2.1 -->
<script src="https://cdn.jsdelivr.net/gh/RaSan147/pixi-live2d-display@1.0.1/dist/cubism2.min.js"></script>

<!-- if only Cubism 4 -->
<script src="https://cdn.jsdelivr.net/gh/RaSan147/pixi-live2d-display@1.0.1/dist/cubism4.min.js"></script>
```
